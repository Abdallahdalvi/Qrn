// @ts-ignore
import { mel_filter_bank, spectrogram, window_function } from "@huggingface/transformers/src/utils/audio.js";
...
function getWindow(): Float64Array {
  ...
  return _window as Float64Array;
}
